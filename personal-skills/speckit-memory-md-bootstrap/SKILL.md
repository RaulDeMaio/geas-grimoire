...
description: "One-time repo setup for the layered Spec-Kit memory workflow: creates memory_root/specs_root folders and durable memory files from extension templates, reading .specify/extensions/memory-md/config.yml. Use before any memory capture/plan-with-memory work in a repo that hasn't been bootstrapped yet."
