...
3.  **Proposal**:
    ...
    *   *If rules were unclear*: Propose an update to `~/.claude/CLAUDE.md` (user scope) or a repo `CLAUDE.md`.
...
1.  **Present Proposals**: Show the user *exactly* what files you recommend creating or updating.
    *   "I recommend creating `.claude/skills/new-skill/SKILL.md`..."
    *   "I recommend adding 'Always use Factory Pattern' to `CLAUDE.md`..."
2.  **WAIT for Approval**: Do **NOT** write any files yet. Ask: "Do you want me to apply these changes?"

## Step 4: Execution

1.  **Apply Changes**:
    *   If approved, Write/Update the files using `Write` or `Edit`.
