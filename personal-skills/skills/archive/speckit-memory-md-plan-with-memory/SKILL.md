...
description: "Before planning a feature, resolves memory config and retrieves durable constraints/decisions from memory so planning is memory-informed. Use at the start of speckit-plan in a repo with the memory-md extension bootstrapped."
