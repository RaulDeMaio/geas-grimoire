...
description: "Turn a high-signal audit finding into a tracker-ready follow-up (GitHub/GitLab/Jira issue) when it's worth acting on but not worth storing as durable memory. Use after speckit-memory-md-audit surfaces a finding that needs action rather than a memory-file edit."
